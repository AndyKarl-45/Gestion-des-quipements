    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des Régions</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <form class="form-horizontal" action="save_region.php" method="POST">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table  table-hover table-condensed" id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="help-block small-font" >NOM DE LA REGION</span>
                                                        <div class="col">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        <thead>
                                                        <tr class="bg-primary">
                                                            <th><p align="center">NOM DE LA REGION</p></th>
                                                        ...
                                                        $query = "SELECT * from region where open_close!='1' ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><a class="btn btn-danger"  href="delete_region.php?id=<?=$id_region?>"  style="background-color: transparent">

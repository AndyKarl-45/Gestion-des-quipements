        ...
        <div class="container-fluid">
            ...
            <!--                Main Body-->
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des fournisseurs.</b>
                                                            <b> 
                ...
                <td align="center" style="width: 18%">              
                    <a class="btn btn-primary"  href="details_fournisseur.php?id=<?php echo $id_fournisseur; ?>" title="view"
                            style="background-color: transparent">
                                <i  style="color: green" class="fas fa-eye"></i> 
                            </a>
                        
              
                         <a class="btn btn-warning" href="modifier_fournisseur.php?id=<?php echo $id_fournisseur;?>" title="Modifier"
                            style="background-color: transparent">
                                <i style="color: orange" class="fas fa-pen"></i> 
                            </a> 
                     
                   
                             <a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_fournisseur<?php echo $id_fournisseur; ?>" title="supprimer"  style="background-color: transparent">

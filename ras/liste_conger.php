...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des Congés</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>Historique des congés Terminés</b>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form class="form-horizontal">
                                        <fieldset>
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center">DATE DE DEBUT</p></th>
                                                            <th><p align="center">DATE DE FIN</p></th>
                                            ...
                                            <tbody>
                                                    ...
                                                    $query = "SELECT * from conger_manager where etat = 1 or etat = 2 or etat= 3";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            $id = $row['id_conger'];
                                                     ...
                                                     ?>
                                                        <tr>
                                                            ...
                                                            <td align="center"><?php echo $motif; ?>  </td>     <td align="center"><?php echo $observation; ?>  </td>
                                                ...
                                                <?php 
                                                            ...
                                                            echo'<button  style=" width:120px;"    class="btn btn-primary" >Approuver
                                                                ...
                                                                echo'<button  style=" width:120px;"  class="btn btn-danger" >Refuser
                                                                 ...
                                                                 echo'<a href="modifier_conger_attente.php?id='.$id.'" style=" width:120px;"    class="btn btn-warning" >En attente

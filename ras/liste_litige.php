                                        ...
                                        <fieldset>
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    ...
                                                    <?php 
                                                            if($nature==1){
                                                            echo'<button  style=" width:140px;"    class="btn btn-primary" >Reconduit(e)
                                                            </button>'; 
                                                            }elseif( $nature ==2) {
                                                                echo'<button  style=" width:140px;"  class="btn btn-danger" >Black liste
                                                            
                                                            </button>';
                                                            }else{
                                                                 echo'<a href="modifier_litige.php?id='.$id_litige.'" style=" width:140px;"    class="btn btn-warning" >En observation</a>';

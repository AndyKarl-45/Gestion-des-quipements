...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des mouvements d'entrée du Mag congo</h1>
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     $query = "SELECT * from demande_materiel where receveur='O' and etat=1 and id_salles=0 ";
                                                                                $q = $db->query($query);
                                                                                while($row = $q->fetch())
                                                                                {
                                                                                    $id = $row['id_materiel'];
                                                                                    ...
                                                                                    $sql = "SELECT DISTINCT * from demande_equipement where receveur='O' and etat=1 and id_ask_eq='$id_ask_eq'";

...
<div class="panelle">
    <form class="form-horizontal" action="update_maintenance_salle.php" method="POST">
...
<button class="accord">Magasin défectueux</button>
<div class="panelle">
        <form class="form-horizontal" action="update_main_def.php" method="POST">
        <input type="hidden" name="id_materiel" value="<?=$id_materiel?>">
  <table  border="0" class="table  table-hover table-condensed" width="100%" cellspacing="0" >
                                                                        <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                background: transparent;" readonly>
                                                                                    <option value="" selected="">Magasin défectueux</option>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="card-footer">
                                                            <center><a href="liste_mag_main.php" style=" width:150px;" class="btn btn-primary" ><font>Annuler</font></a></center>

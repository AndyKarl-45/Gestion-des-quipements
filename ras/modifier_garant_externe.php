...
$query  = "SELECT * from garant_externe where id_garant_ex='".$id."'";
$q = $db->query($query);
while($row = $q->fetch())
{ 
    /*-------------------- ETAT CIVILE --------------------*/
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_garant_externe.php" method="POST">
                                                    <div class="card-header">
                                                    ...
                                                    <input type="hidden" name="id_garant_ex" value="<?=$id?>">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input style="width:75%;
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="profession" value="<?=$profession?>" required>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="proprietaire_local" value="<?=$proprietaire_local?>" required>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="tel_proprietaire" value="<?=$tel_proprietaire?>" required>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>

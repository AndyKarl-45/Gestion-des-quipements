                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                ...
                                                $iResult = $db->query("SELECT * FROM garant_externe where open_close!='1'");
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="sal_base" value="0" >
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="sal_horaire" value="0">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>

                                                ...
                                                <div class="card-body">
                                                    <fieldset>
                                                        <div class="table-responsive">
                                                            ...
                                                            <div class="panelle">
                                                                <form class="form-horizontal" action="update_transfert_materiel_salle_mag.php" method="POST">
                                                                    <input type="hidden" name="ids_source" value="<?=$id?>">
                                                                    <input type="hidden" name="id_materiel" value="<?=$id_materiel?>">
                                                                    <input type="hidden" name="id_ask_mat" value="<?=$id_ask_mat?>">
                                                            ...
                                                            <div class="panelle">
                                                                <form class="form-horizontal" action="update_salle_maintenance_salle_mag.php" method="POST">
                                                                    <input type="hidden" name="ids_source" value="<?=$id?>">
                                                                    <input type="hidden" name="id_materiel" value="<?=$id_materiel?>">
                                                                    <input type="hidden" name="id_ask_mat" value="<?=$id_ask_mat?>">
                                                                    <table  border="0" class="table  table-hover table-condensed" width="100%" cellspacing="0" >

    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">État Salariale Mensuel >> <?=$personnel?> </h1>
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        $style = "";
                                                        $horaire_mensuel = 0;
                                                        $query1 = "SELECT * FROM etat_salarial_mensuel WHERE id_personnel = $id_perso";
                                                        $q1 = $db->query($query1);
                                                        while($row1 = $q1->fetch())
                                                        {
                                                            $personnel = "";
                                                            ...
                                                            <tr>
                                                                <td align="center" class="<?=$style?>"><?=$personnel?></td>
                ...
                <div class="row" id="etats">
                        ...
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">
                                <div class="text-center">
                                    <h1>
                                        <?=number_format($total_dette)?> Fcfa
                                    </h1>
                                </div>
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="#">CRÉDITS</a>
                    ...
                    <!--                                <div class="text-center">-->
                    <!--                                    <h1>-->
                    <!--                                        --><?//=number_format($cpt_personnel)?><!-- Fcfa-->
                    <!--                                    </h1>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    <!--                            <div class="card-footer d-flex align-items-center justify-content-between">-->
                    <!--                                <a class="small text-white stretched-link" href="#">COMPTE</a>-->
                    <!--                                <div class="small text-white"><i class="fas fa-angle-up"></i></div>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                    ...
                    <!--                                <div class="text-center">-->
                    <!--                                    <h1>-->
                    <!--                                        --><?//=number_format( $total_dette - $cpt_personnel) ?><!-- Fcfa-->
                    <!--                                    </h1>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    <!--                            <div class="card-footer d-flex align-items-center justify-content-between">-->
                    <!--                                <a class="small text-white stretched-link" href="#">DETTE TOTAL</a>-->
                    <!--                                <div class="small text-white"><i class="fas fa-angle-up"></i></div>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </div>-->

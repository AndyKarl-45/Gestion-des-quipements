                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des demandes en cours.</b>
                                <b> 
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($lvl == 7)
                                                            $query = "SELECT * from demande_inter WHERE statut=0 and id_salles = (SELECT id_salles FROM salles WHERE secteur = $num_secteur_user)  ";
                                                        if($lvl == 3)
                                                            $query = "SELECT * from demande_inter WHERE statut=0 and id_salles = $id_salle_user   ";
                                                        else
                                                            $query = "SELECT * FROM `demande_inter` WHERE statut=0 and id_salles!=0 ";
                                                        ...
                                                        {   
                                                            ...
                                                            <td align="center"><textarea rows="4" cols="60" style="inline-block"  title="vous pouvez étirez le bloc de text (l'arrêt de droite-bas)!!!" disabled><?php echo $nature; ?></textarea></td>
                                                                <td align="center" style="width:15%"> <?php 

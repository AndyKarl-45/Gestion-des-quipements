                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des formations de campresj.</b>
                                <b> 
                                
                                <!-- Nav pills -->
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="<?=$formation['option1_link']?>">
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center">DATE DE FORMATION</p></th>
                                                            <th><p align="center">STATUT </p></th>
                                                            <th><p align="center">OBSERVATIONS</p></th>
                                                    ...
                                                    <?php
                                                        ...
                                                        {   
                                                            ...
                                                            <tr>
                                                                <input name="id_formation" type="hidden" value="<?php echo $row['id_formation'];?>" />
                                                            <td align="center"><?php
                                                                ...
                                                                ?>  </td>
                                                            <td align="center"><?php echo $date_formation; ?>   </td>
                                                            <td align="center">

                                                    <?php 
                                                            if($statut==1){
                                                            echo'<button  style=" width:120px;"    class="btn btn-primary" >Valider
                                                            </button>'; 
                                                            }elseif( $statut ==2) {
                                                                echo'<button  style=" width:120px;"  class="btn btn-danger" >Refuser
                                                                 ...
                                                                 echo'<a href="modifier_formation.php?id='.$id_formation.'" style=" width:120px;"    class="btn btn-warning" >En cours
                        ...
                        <td align="center">
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                <a class="btn btn-warning" href="modifier_formation.php?id=<?=$id_formation?>" title="Modifier"

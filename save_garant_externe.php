...
{               
        ...
        $query1 = " INSERT INTO garant_externe (nom,prenom,id_card_number,id_card_validity,tel,email,proprietaire_local,tel_proprietaire,date_naissance,lieu_naissance,profession,situation_matrimoniale,nombre_enfants,genre,ville,quartier,pays,open_close) 
        VALUES 
     (:nom,:prenom,:id_card_number,:id_card_validity,:tel,:email,:proprietaire_local,:tel_proprietaire,:date_naissance,:lieu_naissance,:profession,:situation_matrimoniale,:nombre_enfants,:genre,:ville,:quartier,:pays,:open_close)";
        ...
        $sql1 = $db->prepare($query1);
            ...
            $sql1->execute();
                                    ...
                                    if($sql1)
                                    {
                                        ?>
                                        <script>
                                            alert('Garant externe a été bien enregistré.');
                                    ...
                                    {       
                                      ?>
                                        <script>
                                            alert('Garant externe n\'a pas été enregistré.');
                                            window.location.href='<?=$garant['option2_link']?>';
                                        </script>
                                        <?php

...
if($quantite_chantier>=0){
     ...
     if($quantite_total>0){
        ...
        $sql1 = $db->prepare($query1);
         ...
         $sql3 = "SELECT DISTINCT count(id_fournisseur) as total from fournisseur_materiel where  id_materiel='$id_materiel' and id_fournisseur='$id_fournisseur' ";
            ...
            $sql = "INSERT INTO fournisseur_materiel (id_fournisseur, id_materiel)
                                VALUES(:id_fournisseur,:id_materiel)";
        $req = $db->prepare($sql);

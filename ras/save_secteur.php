...
{               
        ...
        $ville_secteur = $_POST['ville_secteur'];
...
//--------------------------------- insertion des pièces jointes par étape -----------------------------------------//
                    ...
                    $query = " INSERT INTO secteur (numero_secteur,nom,tel,responsable,ville_secteur) VALUES (:numero,:nom,:tel,:responsable,:ville_secteur)";
    ...
    $sql->bindParam(':ville_secteur', $ville_secteur);
            $sql->execute();

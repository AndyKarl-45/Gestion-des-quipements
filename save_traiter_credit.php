...
{               
        ...
        $query1 = "UPDATE credit SET nom=:nom, type_conger=:type_conger, start_time=:start_time, modalite=:modalite, montant=:montant, motif=:motif, etat=:etat where id_credit = '$id' ";

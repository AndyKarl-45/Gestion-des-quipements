...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des mouvements d'entrée du Mag Maintenance</h1>
                                        ...
                                        <fieldset>
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     $query = "SELECT * from demande_materiel where  etat=1 and id_salles=0 and receveur='M' ";
                                                                                ...
                                                                                while($row = $q->fetch())
                                                                                {
                                                                                    ...
                                                                                    $sql = "SELECT DISTINCT * from demande_equipement where receveur='M' and etat=1 and id_ask_eq='$id_ask_eq'";
                                                    ...
                                                    <td align="center"><a href="details_materiel.php?id=<?php echo $id_materiel; ?>" style="color: black"> <?php 
                                                    if(isset($date_valide)){

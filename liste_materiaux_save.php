...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des équipements du magasin d'eneregistrement</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des équipements du magasin d'eneregistrement.</b>
                                <b>
                                
                                <!-- Nav pills -->
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="nouveau_materiaux_save.php">
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     <?php
                                                       ...
                                                       $sql = "SELECT DISTINCT * from materiel where mag='E' and open_close!='1'  ";
                            ...
                            ?>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <th class="bg-secondary"><p align="center" style="color: white">
                                                                    <?php
                                                                    $sum=0;
                                                                    $query = "SELECT * from materiel where open_close!='1' and mag='E' ";
                                                                    $q = $db->query($query);
                                                                    while($row = $q->fetch()) {

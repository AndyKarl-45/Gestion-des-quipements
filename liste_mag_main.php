...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des équipements en Maintenance </h1>
            ...
            <!--                Main Body-->
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Tranferts</p></th> 
                                                        </tr>
                                                        </thead>
                                                     ...
                                                     <?php
                                                        ...
                                                        $query = "SELECT * from materiel where open_close!='1'  and id_salles='0'and statut='2' or mag='M' ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                ...
                <td align="center" style="width: 18%">            
                    ...
                    ?>
                        ...
                        <a class="btn btn-primary" href="transfert_maintenance.php?id_materiel=<?=$id_materiel;?>&quantite=<?=$quantite;?>" title="Modifier"
                  ...
                  <?php  } ?>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <th class="bg-secondary"><p align="center" style="color: white">
                                                                    <?php
                                                                    $sum=0;
                                                                    $query = "SELECT * from materiel where open_close!='1' and statut='2' and id_salles='0' ";
                                                                    $q = $db->query($query);
                                                                    while($row = $q->fetch()) {
                                                                        $quantite = $row['quantite'];
                                                                        $sum=$sum+$quantite;

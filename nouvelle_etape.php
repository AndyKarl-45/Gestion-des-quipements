...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Equipements Déffecteux</h1>
                                            ...
                                            <div class="card mb-4">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table  border="0" class="table  table-hover table-condensed" width="100%" cellspacing="0" id="myTable">
                                                                 ...
                                                                 <input type="hidden" name="id_chantier" value="<?=$id_chantier?>">
                                                                        ...
                                                                        <td>
                                                                <input type="hidden" name="objet_chantier" value="<?=$objet_chantier?>">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                            <input type="hidden" name="date_begin_chantier" value="<?=$date_begin_chantier?>"> 
                                                                        ...
                                                                        <td>
                                                        <input type="hidden" name="montant_ttc_chantier" value="<?=$montant_ttc_chantier?>">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                " name="montant_ttc_chantier" value="<?=$montant_ttc_chantier?>" disabled>
                                                                            </button> 
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style=" color: gray; background-color: silver">
                                                                            <td colspan="2" align="center"> 
                                                                                <i class="fas fa-scroll"></i>
                                                                                <b>Saisir les infos sur l'équipement défectueux.</b>
                                                                                 <b>
                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td style=" width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" required="Veillez insérer le client">
                                                ...
                                                $iResult = $db->query("SELECT * FROM etape_chantier where open_close!='1'");
                                                    ...
                                                    ?>           
                                                                    ...
                                                                    <a href="liste_etape_chantier.php"><i class="fas fa-plus"></i></a>
                                                                    </button>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="cout_etape" value="0" required>FCFA
                                                                     ...
                                                                     <tr>                                                <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="date_debut_etape"  required>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="date_fin_etape"  required>
                                                    ...
                                                    <div class="card-footer">
                                                      ...
                                                      <center> <button type="submit" style=" width:150px;"  name="submit_salle"  class="btn btn-primary" >Enregistrer</button>
                                                        ...
                                                        <a href="details_chantier?id=<?=$id_chantier?>" style=" width:150px;" class="btn btn-primary" ><font>Annuler</font></a>
                                                        </center>
                                                          </form> 
                                </div>

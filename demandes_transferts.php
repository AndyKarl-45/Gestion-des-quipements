    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <?php
                if($lvl == 2 ||$lvl == 4 || $lvl == 3 || $lvl == 6 || $lvl == 9 || $lvl == 11){
                    if ($lvl == 4) {
...
//                            Chargement des données de la demande
                    ...
                    <?php
                    if ($lvl == 2 || $lvl == 9 || $lvl == 3 || $lvl == 11 || $lvl == 6) {
                        ?>
                        <!--                Main Body-->
                        <div class="row">
                            <div class="col-xl-12">
                                                ...
                                                <table class="table table-bordered table-hover table-condensed" id="myTable">
                                                    ...
                                                    <tr>
                                                        <td style="width:60%">
                                                            <label>Auteur</label>
                                                            <div class="col">
                                                                <input  class="form-control" name="auteur" value="<?=$user.'/'.$grade?> (<?=$secteur_user?>)" style="width:100%;
                                                        border-top: 0; border-left: 0;
                                                        border-right: 0;
                                                        background: transparent" readonly>
                                                            </div>
                                                        ...
                                                        <td style="width:40%">
                                                            <label >Montant </label>
                                                            <div class="col">
                                                                <input  class="form-control" type="number" name="montant" value="0" style="width:100%; >
                                                        border-top: 0; border-left: 0;
                                                        border-right: 0;
                                                        background: transparent" required>
                                                            </div>

...
<div class="modal fade" id="verifier_delete_region<?= $id_region; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_region.php" name="form" method="post">
                    <div class="form-group" style=" text-align: center;">
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" name="id_region" value="<?= $id_region; ?>" class="form-control">
                        </div>
                    </div>

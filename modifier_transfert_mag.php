                        ...
                        <div class="card-header">
                            <b>
                                 <ul class="nav nav-pills" style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="liste_transfert_mag.php">
                                            Retour
                                        </a>
                                    </li>                              
                                </ul>
                                ...
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu2">
                                            ...
                                            $query = "SELECT DISTINCT count(id_materiel) as total from demande_materiel where     id_salles='$id_salles'  and id_ask_eq='$id_ask_eq'";
                                            $q = $db->query($query);
                                            while($row = $q->fetch())
                                            {
...
<!--********************************************ETAT CIVILE************************************************* -->
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_ask_eq.php" method="POST">
                                                    <div class="card-header">
...
<!--********************************************INFO RH************************************************* -->
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="ajouter_ask_eq.php?idi=<?=$id_ask_eq?>&ids=<?=$id_salles?>">
                                            <i class="fas fa-cubes"></i>
                                            Ajouter éqquipement
                                        </a>
                                    </li>                                    
                                                                ...
                                                                <div class="table-responsive">
                                                                    <form method="post" action="" >
                                                                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                                            ...
                                                                            $sql = "SELECT DISTINCT * from demande_materiel where id_salles='$id_salles' and id_ask_eq='$id_ask_eq' ";
                ...
                <td align="center" style="width: 18%">              
                    <a class="btn btn-danger"  href="delete_ask_eq.php?idi=<?php echo $id_ask_eq; ?>&ids=<?php echo $id_salles?>&idm=<?=$id_materiel?>" title="view"

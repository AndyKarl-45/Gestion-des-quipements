...
<!--********************************************ETAT ACADEMIQUE************************************************* -->
                             ...
                             <div class="card-header">
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active"  href="liste_pj_aca?id_personnel=<?=$id_personnel?>">
                                            <i class="fas fa-cubes"></i>
...
<!--********************************************ETAT PROFESSIONNEL************************************************* -->
                             ...
                             <div class="card-header">
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active"  href="liste_pj_prof?id_personnel=<?=$id_personnel?>">
                                            <i class="fas fa-cubes"></i>
                                            Liste des Pièces jointes <!-- <?=$id_personnel?> -->
                                        </a>
                                    </li>                                    
...
<?php
                                                        ...
                                                        $query = "SELECT * from sanction where id_personnel='".$id."'";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {

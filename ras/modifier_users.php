        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="" method="POST">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" value="<?=strtoupper($personnel)?>" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <div class="col">
                                                            <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" value="<?=strtoupper($lvl_user)?>" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        if($salle == "0")
                                                            $salle = "N/A";
                                                        ?>
                                                        <select name="salle" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" value="<?=$pseudo?>" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" value="XXXXXXXXXXXXXXXXXXXXXXXXXX" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                ...
                <center>
                    ...
                    if($lvl == 4 || $lvl == 5){
                    ?>
                    <button type="button" data-toggle="modal" data-target="#editMdp" class="btn btn-primary">Changer de Mot de passe</button>
                    <?php
                    }
                    ?>

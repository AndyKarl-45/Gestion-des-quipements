                                                                ...
                                                                ?>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="objet_chantier" value="<?=$objet_chantier?>" disabled>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                " name="montant" value="<?=$montant_ttc_chantier?>" disabled>
                                                                            </button> 
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="nom_etape" value="<?=$nom_etape?>" disabled>
                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                " name="cout" value="<?=$cout_etape?>" disabled>FCFA
                                                                     ...
                                                                     <tr>                                                <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                " name="date_debut" value="<?=$date_debut_etape?>" disabled>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                " name="date_fin" value="<?=$date_fin_etape?>" disabled>
...
<!--********************************************CLIENT************************************************* -->
            ...
            <tr>
                ...
                <td align="center"><a href="details_personnel.php?id=<?php echo $id; ?>" title="<?=$nom; ?>" style="color: black"><?=$nom.' '.$prenom; ?></a>  </td>
                <td align="center"><a href="details_personnel.php?id=<?php echo $id; ?>" title="<?= $poste; ?>" style="color: black"><?=$poste; ?></a>   </td>       
                <td align="center"><a href="details_personnel.php?id=<?php echo $id; ?>" title="<?=$tel; ?>" style="color: black"><?=$tel ?> </a>  </td> 
                <td align="center"><a href="details_personnel.php?id=<?php echo $id; ?>" title="<?=$statut; ?>" style="color: black"><?=$statut; ?></a>   </td>
                 <input type="hidden" name="" value="<?=$profession; ?>">
                  <td align="center"><a href="details_personnel.php?id=<?php echo $id; ?>" title="<?=$id_quartier; ?>" style="color: black">
                     <?php
...
<!--********************************************MATERIAUX************************************************* -->
                ...
                <td align="center" style="width: 18%">              <a href="ajouter_transfert_etape.php?id_mat=<?=$id?>&id_et=<?=$id_etape?>" style=" width:120px;"    class="btn btn-primary" >Ajouter
                                                            
                                                            </a>
                        
              
                      <!--    <a class="btn btn-warning" href="modifier_materiel.php?id=<?//=$id;?>" title="Modifier"
                            style="background-color: transparent">
                                <i style="color: orange" class="fas fa-pen"></i> 
                            </a> 
                     
                   
                             <a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_materiel<?//= $id; ?>" title="supprimer"  style="background-color: transparent">
...
<!--********************************************ENGINS************************************************* -->
                                                ...
                                                <div class="well bs-component">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Fournisseurs</p></th>
                                                            <th><p align="center" style="color: white">Type d'engin</p></th>
                                                            <th><p align="center" style="color: white">Conducteurs</p></th>
                                                            <th><p align="center" style="color: white">Chantiers</p></th>
                                                            <th><p align="center" style="color: white">Date d'arrivée</p></th>
                                                            <th><p align="center" style="color: white">Date de depart</p></th>
                                                            <th><p align="center" style="color: white">Options</p></td>
                                                        </tr>
                                                        </thead>
                ...
                <td align="center" style="width: 18%">              <a class="btn btn-primary"  href="details_engin.php?id=<?php echo $id_engin; ?>" title="view"
                            style="background-color: transparent">
                                <i  style="color: green" class="fas fa-eye"></i> 
                            </a>
                        
              
                         <a class="btn btn-warning" href="modifier_engin.php?id=<?=$id_engin;?>" title="Modifier"
                            style="background-color: transparent">
                                <i style="color: orange" class="fas fa-pen"></i> 
                            </a> 
                     
                   
                             <a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_engin<?=$id_engin; ?>" title="supprimer"  style="background-color: transparent">
                                  <i style="color: red" class="fas fa-trash"></i>
                            </a>  

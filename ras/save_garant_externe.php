...
{               
        ...
        $query1 = " INSERT INTO garant_externe (nom,prenom,id_card_number,id_card_validity,tel,email,proprietaire_local,tel_proprietaire,date_naissance,lieu_naissance,profession,situation_matrimoniale,nombre_enfants,genre,ville,quartier,pays) 
        VALUES 
                                    ...
                                    if($sql1)
                                    {
                                        ...
                                        <script>
                                            alert('Garant externe a été bien enregistré.');
                                                 window.location.href='<?=$garant_ex['option2_link']?>';
                                        </script>
                                        <?php
                                    }

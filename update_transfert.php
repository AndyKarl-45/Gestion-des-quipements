     ...
     if($quantite_total>=0){
        ...
        $sql = $db->prepare($query);
            ...
            if($quantite_total>0)
                         ...
                         $sql = "SELECT DISTINCT * from magasin_chantier where id_chantier = '$id_chantier' and id_materiel='$id_materiel'";
                                                                ...
                                                                foreach($tables as $table)
                                                                {
                                                                    ...
                                                                    $prix_unitaire=$table['prix_unitaire_mag_chantier'];
                                                                    ...
                                                                    // echo $date_final.'<br/>';
                                                                    $prix_total_final=$quant_final*$prix_unitaire;
                                                                    // echo $prix_total_final.'<br/>';


         $query = "UPDATE magasin_chantier SET  quantite_chantier=:quantite_chantier, date_mag_chantier=:date_mag_chantier, prix_total_mag_chantier=:prix_total_mag_chantier where id_materiel = '$id_materiel' and id_chantier='$id_chantier' ";

                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#a2">
                                            ...
                                            Employé
                                                    ...
                                                    <div class="tab-content">
                                                            <div class="tab-pane  active" id="a1">
                                                                <span class="help-block small-font" >Postulant</span>
                                                                <div class="col">
                                                                    <select name="id_postulant"  style="width:45%;
                                            ...
                                            <button type="button" data-toggle="modal"  style="background-color: transparent"><a href="nouveau_personnel.php"><i class="fas fa-plus"></i></a>
                                                        ...
                                                        <div class="tab-pane " id="a2">
                                                            <span class="help-block small-font" >Employé</span>
                                                            <div class="col">
                                                                <select name="id_employe" style="width:45%;
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                    <option value="0" selected>...</option>
                                                                    ...
                                                                    $iResult = $db->query('SELECT * FROM personnel where statut="EMPLOYE" ');
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                background: transparent;"required >
                                                                                    <option value=""selected >...</option>   <option value="4">Elimination</option>   

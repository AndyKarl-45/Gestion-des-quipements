...
$query  = "SELECT * from fournisseur where id_fournisseur='".$id_four."'";
$q = $db->query($query);
while($row = $q->fetch())
{ 
        ...
        <div class="container-fluid">
            ...
            <!--                Main Body-->
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <form action="save_pers_quantite.php" method="post">
                            <div class="card-header">
                              <b> 
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                       <a class="nav-link active" href="details_fournisseur.php?id=<?=$id_fournisseur?>">
                                                                                       Retour
                                        </a>
                                    </li>                                    
                                </ul> 
                                                ...
                                                <form method="post" action="" >
                                                     ...
                                                     <?php
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <!-- <input name="id_materiel" type="hidden" value="<?php echo $id_materiel;?>" /> -->

                                                        <td align="center"> <?php echo $designation; ?>   </td>


                                                     <td align="center"> <?php $sql = "SELECT DISTINCT * from categorie_materiel where id_cat_materiel = '$id_cat_materiel'";
                ...
                <td align="center" style="width: 18%">              
                 <div class="btn-group mr-2" role="group" aria-label="First group">
                     <input type="checkbox"  style=" width: 25px; height: 25px" name="id_materiel[]" value="<?=$id_materiel?>">
                 </div>
                    </td>  

                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_etape.php" method="POST">
                                                    <div class="card-header">
                                                                       ...
                                                                       <td style=" width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                background: transparent;" required="Veillez insérer le client">
                                                                                    <option value="<?=$nom_etape?>" selected=""><?=$nom_etape?></option>
                                                                   <?php
                                                                    ...
                                                                    <a href="liste_etape_chantier.php"><i class="fas fa-plus"></i></a>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="cout_etape" value="<?=$cout_etape?>" required>FCFA
                                                                     ...
                                                                     <tr>                                                <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="date_debut_etape" value="<?=$date_debut_etape?>" required>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                border-color: gray" name="date_fin_etape"  value="<?=$date_fin_etape?>" required>

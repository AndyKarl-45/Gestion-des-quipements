...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Nouvel Utilisateur</h1>
                ...
                <div class="col-xl-12">
                    <div class="card mb-4">
                                    ...
                                    switch ($err){
                                        ...
                                        case 'success';
                                            ...
                                            <div class="alert alert-success">
                                                <strong>Succès : </strong> inscription réussie, vous pouvez vous connecter en cliquant sur "Connexion" !
                                            </div>
                                            <?php
                                            break;
                                    }
                        ...
                        <form class="form-horizontal" action="inscription_traitement.php" method="POST">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                    border-right: 0;
                                                                                    background: transparent;" name="nom" required="required">
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                    border-right: 0;
                                                                                    background: transparent;" name="prenom" required="required">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <input style="width:75%;border-top: 0; border-left: 0;
                                                                                    border-right: 0;
                                                                                    background: transparent;" name="email" type="email">
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="col">
                                                            <input style="width:75%;border-top: 0; border-left: 0;
                                                                                    border-right: 0;
                                                                                    background: transparent;" name="pseudo" required>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <div class="col">
                                                        <input type="password" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="password" required>
                                                    </div>
                                                </td>
                                                </tr>
                                            </tbody>
                            ...
                            <center>
                                <button type="submit" style=" width:150px;"  name="submit_user" class="btn btn-primary" >Créer</button>
                                <a href="liste_utilisateurs.php" style=" width:150px;" class="btn btn-primary" ><font>Annuler</font></a>
                            </center>
                        </form>

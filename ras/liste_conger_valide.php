...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des Congés à valider</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>Historique des congés en cours...</b>
                            </div>
                            <div class="card-body">
                                        ...
                                        <fieldset>
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    ...
                                                    $query = "SELECT * from conger_manager where etat = 0";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            $id = $row['id_conger'];
                                ...
                                <ul class="nav nav-pills">
                                     &nbsp &nbsp &nbsp &nbsp<li class="nav-item" >
                                        <a class="nav-link active" href="modifier_conger.php?id=<?php echo $id; ?>">

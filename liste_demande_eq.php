...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des demandes d'équipements </h1>
                                ...
                                <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                    <li class="nav-item">
                                        <a class="nav-link" href="liste_demande_echec.php">
                                            ...
                                            if($lvl == 3)
                                                $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel WHERE id_salles = $id_salle_user and etat=-1 and id_salles!=0 order by id_ask_eq desc";
                                            else
                                                $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel where etat=-1 and id_salles!=0  and id_salles!=0  order by id_ask_eq desc";
                                ...
                                <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                    <li class="nav-item">
                                        <a class="nav-link" href="liste_demande_traitement.php">
                                            ...
                                            if($lvl == 3)
                                                $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel WHERE id_salles = $id_salle_user and etat_t=1 and etat=0 and id_salles!=0 order by id_ask_eq desc";
                                            else
                                                $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel where etat_t=1 and etat=0 and  id_salles!=0   order by id_ask_eq desc";
                                 ...
                                 <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                    <li class="nav-item">
                                        <a class="nav-link" href="liste_demande_eq_suite.php">
                                           
                                            <?php

                                                     if($lvl == 3)
                                                         $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel WHERE id_salles = $id_salle_user and etat=0 and etat_t=0 and id_salles!=0 order by id_ask_eq desc";
                                                     else
                                                         $query = "SELECT DISTINCT count(id_ask_eq) as total from demande_materiel where etat=0 and etat_t=0 and id_salles!=0  order by id_ask_eq desc";
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     if($lvl == 3)
                                                         $query = "SELECT * from demande_equipement WHERE id_salles = $id_salle_user and etat=1 order by id_ask_eq desc";
                                                     else
                                                         $query = "SELECT * from demande_equipement where etat=1 order by id_ask_eq asc";

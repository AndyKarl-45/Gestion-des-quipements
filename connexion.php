...
<body onload="myFunction()" class="jumbotron">
    ...
    <div style="display:none;" id="myDiv" class="animate-bottom">
        ...
        <div class="row">
            ...
            <div class="alert alert-danger col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                <strong>PME Market</strong>
                <hr style="width: 100px; margin-top: 2; margin-bottom: 2;" />
                <i>Abonnez-vous et profitez des promotions de nos partenaires.</i>

                <a href="https://www.pmemarket.net" target="_blank">Cliquez ici</a> 
            </div>
    </div>

            ...
            <!--                Main Body-->
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = "SELECT * from parrain_externe";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                          $id = $row['id_parrain_ex']; 
                                                            $nom = $row['nom'];
                                                            $prenom = $row['prenom'];
                                                            ...
                                                            <tr>
                                                                <input name="id_garant_ex" type="hidden" value="<?php echo $row['id_parrain_ex'];?>" />
                ...
                <td align="center">
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="First group">
                         <a class="btn btn-primary"  href="details_parrain_externe.php?id=<?= $id; ?>" title="view"

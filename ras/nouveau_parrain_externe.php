...
include('php/main_side_navbar.php');
 ...
 $query  = "SELECT id_parrain_ex as total, count(nom) as i from parrain_externe";
$q = $db->query($query);
while($row = $q->fetch())
{   $i= $row["i"];
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Fiche d'Inscription des Parrains Externes</h1>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="save_parrain_externe.php" method="POST">
                                                    <div class="card-header">
                                                                ...
                                                                <table class="table  table-hover table-condensed" id="myTable">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input style="width:75%;
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="profession"required>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="proprietaire_local" required="">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="tel_proprietaire" required>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>

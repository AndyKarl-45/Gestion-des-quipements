                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des transferts d'équipements.</b>
                                                            <b> 
                                <?php if ($lvl == 4 || $lvl==0 || $lvl==5 || $lvl==6){ ?>
                                <!-- Nav pills -->
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="nouveau_transfert_mag_main.php">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     // else
                                                         $query = "SELECT * from demande_equipement where (emetteur='M' and receveur='E') or (emetteur='M' and receveur='C') or (emetteur='M' and receveur='D') or (emetteur='M' and receveur='O') order by date_debut , date_valide, id_ask_eq desc ";
...
<td align="center"><a href="details_transfert_mag_congo.php?id=<?php echo $id_ask_eq; ?>" style="color: black"> <?php if($receveur=='E'){ echo "Mag d'ennregistrement"; }  if($receveur=='O') { echo "Mag congo"; } if($receveur=='C'){ echo "Mag centrale";} if($receveur=='D'){ echo "Mag Défectueux";}?>  </a></td>
                ...
                <td align="center" style="width: 18%">              
                    <a class="btn btn-primary"  href="details_transfert_mag.php?id=<?php echo $id_ask_eq; ?>" title="view"
                ...
                <?php 
                            if($etat!=1){
                                ...
                                echo' <a class="btn btn-primary" href="modifier_transfert_mag_main.php?id='.$id_ask_eq.'"><i class="fa fa-pencil-alt"></i></a>||<a class="btn btn-primary" href="valider_transfert_mag.php?idi='.$id_ask_eq.'&ids='.$receveur.'&ide='.$emetteur.'"><i class="fa fa-check"></i></a>';

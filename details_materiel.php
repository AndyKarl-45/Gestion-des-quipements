...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Détails de l'équipement : <?= $ref_materiel ?> </h1>
                                                                ...
                                                                <table class="table  table-hover table-condensed" id="myTable">
                                                                    <tbody>
                                                                     ...
                                                                     <tr>
                                                                        <td style="width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                value="<?php  echo $ref_materiel?>" disabled="">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                     ...
                                                                     <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="designation"  
                                                                    ...
                                                                    <tr>
                                                                         <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="quantite" value="<?php echo number_format($quantite)?>" disabled="">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                " name="prix_unitaire" value="<?php echo $prix_unitaire?>" disabled="">
                                                                            </button> 
                                                                            </div>
                                                                    </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;
                                                                                " name="prix_total" value="<?php echo $prix_total ?>" disabled="">
                                                                            </button> 
                                                                            </div>
                                                                        </td>
                                                                    </tr>
...
<div class="tab-pane container" id="menu1">
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="ajouter_four_materiel.php?id_materiel=<?=$id_materiel?>">
                                            <i class="fas fa-cubes"></i>
                                            Ajouter fournisseur 
                                        </a>
                                    </li>                                    
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table  table-hover table-condensed" id="myTable">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Raison Sociale</p></th>
                                                            <th><p align="center" style="color: white">Tel</p></th>
                                                            <th><p align="center" style="color: white">Contact</p></th>
                                                            <th><p align="center" style="color: white">Tel contact</p></th>
    ...
    $sql = "SELECT DISTINCT id_materiel,id_fournisseur from fournisseur_materiel where id_materiel = '$id_materiel'";
                ...
                <td align="center" style="width: 18%">              <a class="btn btn-primary"  href="details_fournisseur.php?id=<?php  echo $id; ?>" title="view"
                            style="background-color: transparent">
                                <i  style="color: green" class="fas fa-eye"></i> 
                            </a>
                        
              
<!--                          <a class="btn btn-warning" href="modifier_fournisseur.php?id=<?//=$id;?>" title="Modifier"
                            style="background-color: transparent">
                                <i style="color: orange" class="fas fa-pen"></i> 
                            </a> 
                     
                   
                             <a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_fournisseur<?//= $id; ?>" title="supprimer"  style="background-color: transparent">
                        ...
                        //include("verifier_delete_client.php");
                            ?> -->
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <th><p align="center" style="color: white">Contact</p></th>
                                                            <th><p align="center" style="color: white">Tel contact</p></th>
                                                            <th style="width: 18%"><p align="center" style="color: white">Options</p></td>
                                                            </tr>
                                                        </tfoot>
                                                                    </table>
...
<!--********************************************INFO PAIE************************************************* -->
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-scroll"></i>
                                <b>L'ensemble de l'équipement par salle.</b>
                                <b> 
                                
                                <!-- Nav pills -->
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="ajouter_materiel_chantier.php?id_materiel=<?=$id_materiel?>">
                                            <i class="fas fa-cubes"></i>
                                            Ajouter matériel 
                                        </a>
                                    </li>                                    
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Quantité(s)</p></th>
                                                            <th><p align="center" style="color: white">date de transfert</p></th>
                                                     ...
                                                     <?php
                                                        ...
                                                        <td align="center"> <?php
                                                         $sql = "SELECT DISTINCT * from salles where id_salles = '$id'";
                ...
                <td align="center" style="width: 18%">             <!--  <a class="btn btn-primary"  href="details_materiel.php?id=<?php echo $id; ?>" title="view"
                            style="background-color: transparent">
                                <i  style="color: green" class="fas fa-eye"></i> 
                            </a>
                   ...
                   <a href="ajouter_transfert_chantier.php?id_materiel=<?=$id_materiel?>&id_chantier=<?=$id?>" style=" width:80px;"    class="btn btn-primary" >Ajouter</a>
                   ...
                   <!--  <?php 
                        //include("verifier_delete_materiel.php");
                            ?> -->
                                                        ...
                                                        <tfoot>
                                                            <tr class="bg-primary">
                                                            <th><p align="center" style="color: white">Nom du Chantier</p></th>
                                                            <th><p align="center" style="color: white">Quantité(s)</p></th>
                                                            <th><p align="center" style="color: white">date de transfert</p></th>
                                                            <th><p align="center" style="color: white">Prix unitaire</p></th>
                                                            <th><p align="center" style="color: white">Prix total</p></th>

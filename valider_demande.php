...
<?php
  ...
  //                }
    ...
    //-----------------------------------------------------------------------//
        ...
        $sql="SELECT * FROM demande_materiel where id_salles='$id_salles'  and id_ask_eq='$id_ask_eq' and receveur='$receveur' ";
                            $stmt = $db->prepare($sql);
                            $stmt->execute();
...
//                    }
                ...
                $etat_t=1;
                $post=0;
                 $query  = " UPDATE demande_materiel  SET   etat=:etat, post=:post, etat_t=:etat_t  WHERE emetteur='$emetteur' and id_salles='$id_salles'  and id_ask_eq='$id_ask_eq'";

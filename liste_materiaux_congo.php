...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des équiepements du magasin du congo</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des équipements du magasin du congo.</b>
                                <b>
                                
                                <!-- Nav pills -->
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="nouveau_materiaux_congo.php">
                            ...
                            ?>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <th class="bg-secondary"><p align="center" style="color: white">
                                                                    <?php
                                                                    $sum=0;
                                                                    $query = "SELECT * from materiel where open_close!='1' and mag='O' ";
                                                                    $q = $db->query($query);
                                                                    while($row = $q->fetch()) {

...
{               
        ...
        $query1 = " INSERT INTO personnel (nom,prenom,id_card_number,id_card_validity,tel,email,nom_pere,nom_mere,date_naissance,lieu_naissance,profession,situation_matrimoniale,nombre_enfants,genre,id_quartier,id_ville,id_pays) 
        VALUES 
        (:nom,:prenom,:id_card_number,:id_card_validity,:tel,:email,:nom_pere,:nom_mere,:date_naissance,:lieu_naissance,:profession,:situation_matrimoniale,:nombre_enfants,:genre,:id_quartier,:id_ville,:id_pays)";

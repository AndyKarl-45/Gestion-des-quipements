    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                $query2 = "SELECT * FROM secteur WHERE nom = '$secteur_user' ";
                $q2 = $db->query($query2);
                while($row2 = $q2->fetch())
                {
                    $id_secteur_user = $row2['id_secteur'];
                }

                if($lvl != 7)
                    $query = "SELECT * FROM users WHERE lvl = 2 ";
                else
                    $query = "SELECT * FROM users WHERE lvl = 2 AND secteur = $id_secteur_user";
                    ...
                    <div class="row" id="etats">
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="etats_manager.php?pseudo=<?=$pseudo?>"><?=number_format($total_entree)?> Fcfa</a>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="etats_manager.php?pseudo=<?=$pseudo?>"><?=number_format($total_sortie)?> Fcfa</a>
                                    <div class="small text-white"><i class="fas fa-angle-up"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="etats_manager.php?pseudo=<?=$pseudo?>"><?=number_format($total_entree - $total_sortie) ?> Fcfa</a>
                                    <div class="small text-white"><i class="fas fa-angle-up"></i></div>
                                </div>
                            </div>
                        </div>

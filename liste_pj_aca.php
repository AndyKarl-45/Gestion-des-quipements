...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
           <h1 class="mt-4">Détails du Personnel (Pièces jointes): <?= $nom.' '.$prenom ?></h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <b> 
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active"  data-toggle="modal" data-target="#ajouter_pj<?=$id?>" href="#">
                            ...
                            <div class="card-body">
                                <div class="well bs-component">
                                    <form class="form-horizontal">
                                        ...
                                        $query = "SELECT * from pj_etat_academique where id_personnel='".$id."' ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            $nom_pj  =$row['nom_pj'];

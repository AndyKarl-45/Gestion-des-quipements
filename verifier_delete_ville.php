...
<div class="modal fade" id="verifier_delete_ville<?= $id_ville; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_ville.php" name="form" method="post">
                    ...
                    ?></b>
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" name="id_ville" value="<?= $id_ville; ?>" class="form-control">
                       </div>
                    </div>

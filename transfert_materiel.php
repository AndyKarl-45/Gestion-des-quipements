...
<!--                     <input type="hidden" name="id_chantier" value="<?=$id?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="quantite_mag_chantier"    class="form-control" required="Entrer la Quantitée">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Date de transfert</label>
                        <div class="col-sm-12">
                            <input type="text" name="date_arrived_mag_chantier"   class="form-control" required="Entrer la date">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">

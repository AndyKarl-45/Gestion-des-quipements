            ...
            $id_ask_eq_sal=$_REQUEST['ideq'];
                ...
                $query  = " UPDATE demande_equipement_sal  SET   etat=:etat, date_valide=:date_valide, heure=:heure    
                         ...
                         $sql = $db->prepare($query);
                                ...
                                $sql->execute();
                 $etat=-1;
                 $query  = " UPDATE demande_materiel  SET   etat=:etat WHERE id_materiel='$id_materiel' and id_salles='$id_salles'";
...
//                $sql1->execute();
                ?>
                <script>
                    alert('Quantité du matériel Insuffisante !!!.');

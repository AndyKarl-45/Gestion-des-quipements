                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane container active" id="home">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <form class="form-horizontal" action="save_conger.php" method="POST">
                                                        <div class="card-header">
                                                    ...
                                                    ?>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="date" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="end_time" required>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                ...
                                                $iResult = $db->query('SELECT * FROM personnel');
                                                    ...
                                                    ?>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="type_conger" class="form-horizontal" required>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                ...
                                                <b>Historique des demande congés</b>
                                            </div>
                                            <div class="card-body">
...
<?php
                                                    ...
                                                    $query = "SELECT * from conger_manager ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            $nom = $row['nom'];

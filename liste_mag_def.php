...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des équipements Défectueux</h1>
            ...
            <!--                Main Body-->
                <div class="row">
                                                ...
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     <?php
                                                        ...
                                                        $query = "SELECT * from materiel where open_close!='1' and statut='3' or mag='D' ";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                    ...
                    ?>
                        ...
                        <a class="btn btn-danger" href="delete_materiel.php?id_materiel=<?=$id_materiel;?>" title="Supprimer"

                                                    ...
                                                    <?php
                                                        ...
                                                        while($row = $q->fetch())
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><a class="btn btn-danger" type="button" data-toggle="modal" data-target="#verifier_delete_nature_dette<?=$id_nat_dette; ?>" title="supprimer"  style="background-color: transparent">
                                                                <i style="color: red" class="fas fa-trash"></i>
                                                        </a></td>
                                                                             <?php 
                        include("verifier_delete_nature_dette.php");
                            ?> 
                                                            </tr>

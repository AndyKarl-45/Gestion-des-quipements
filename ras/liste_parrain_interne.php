...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Liste des Parrains</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des parrains de campresj.</b>
                                                            <b> 
                                
                                <!-- Nav pills -->
<!--                                 <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="<?=$parrain_ex['option1_link']?>">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = "SELECT * from personnel where  parrain_interne!=0";
                                                        $q = $db->query($query);
                                                        while($row = $q->fetch())
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                $sql = "SELECT DISTINCT * from personnel where id_personnel = '$id_parrain_in'";
                                                                ...
                                                                {
                                                                    echo '<td align="center">'.$table['nom'].' '.$table['prenom'].' </td>';
                                                                    echo '<td align="center">'.$table['poste'].' </td>';
                                                                    echo '<td align="center">'.$table['secteur'].' </td>';
                                                                    echo '<td align="center">'.$table['salle'].' </td>';
                                                                    echo '<td align="center">'.$table['statut'].' </td>';
                                                                }
...
<!--                                                             <td align="center"><?php echo $id_card_number; ?>   </td>
               ...
               <td align="center">
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="First group">
                         <a class="btn btn-primary"  href="details_parrain_fiols.php?id=<?= $id_parrain_in; ?>" title="view"

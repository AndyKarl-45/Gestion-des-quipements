                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_salle.php" method="POST">
                                                    <div class="card-header">
                                                        ...
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <table  border="0" class="table  table-hover table-condensed" width="100%" cellspacing="0" id="myTable">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input type="hidden" name="id_salles" value="<?=$id?>">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" >
                                                                                    <option value="<?=$secteur?>" selected=""><?=$secteur?></option>                                                            <?php
                                        ...
                                        $iResult = $db->query('SELECT * FROM pays');
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                <input style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="ville" value="<?=$ville?>" required>
                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="quartier" value="<?=$quartier?>" required>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                ...
                                                $iResult = $db->query('SELECT * FROM personnel');
                                                    ...
                                                    <div class="card-footer">
                                                      ...
                                                      <center> <button type="submit" style=" width:150px;"  name="submit_salle"  class="btn btn-primary" >modifier</button>

                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_transfert_quantite.php" method="POST">
                                                    <div class="card-header">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="quantite_chantier" required>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="date_mag_chantier" required>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <div class="card-footer">
                                                      ...
                                                      <center> <button type="submit" style=" width:150px;"  name="submit_salle"  class="btn btn-primary" >Enregistrer</button>
                                                        ...
                                                        <a href="details_materiel.php?id=<?php echo $id_materiel?>" style=" width:150px;" class="btn btn-primary" ><font>Annuler</font></a>
                                                        </center>
                                                          </form> 
                                </div>

...
<div class="modal fade" id="verifier_delete_sanction<?= $id_sanction; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form class="form-horizontal" action="delete_sanction.php" name="form" method="post">
                    <div class="form-group">
                        <label>Vous êtes sur de vouloir supprimer: 
                        </br><b style="color :red">Nom:                                                       <?php
                                                                ...
                                                                ?>   
                    </br>Nature: <?= $nature?></b></label>
                        <div class="col-sm-12">
                            <input type="hidden" name="id_sanction" value="<?= $id_sanction; ?>" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">

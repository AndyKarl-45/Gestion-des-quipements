                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card mb-4">
                                                <form class="form-horizontal" action="update_fournisseur.php" method="POST">
                                                    <div class="card-header">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="ref_four"  value="<?=$ref_four?>" required>
                                                                            </div>
                                                                        </td>
                                                                        <td style="width: 50%">
                                                                            ...
                                                                            <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="raison_social_four"
                                                                                value="<?=$raison_social_four?>" required>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="tel_four" value="<?=$tel_four?>" required>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="col">
                                                                                <input  style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;" name="pers_contact_four" value="<?=$pers_contact_four?>">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                                ...
                                                                                border-right: 0;
                                                                                background: transparent;" name="tel_contact_four"  value="<?=$tel_contact_four?>">
                                                                                </div>

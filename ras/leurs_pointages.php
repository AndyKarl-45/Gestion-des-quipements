                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <h5><b><u>NB:</u></b> Veillez saisir le pointage de vos collègues, rassurez vous d'avoir du personnel dans le même secteur que vous</h5>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card mb-4">
                                            ...
                                            <form class="form-horizontal" action="<?= $form?>" method="POST">
                                                ...
                                                <input type="hidden" name="id_perso_0" value="<?=$id_0?>">
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        $query = "SELECT * from pointage where utilisateur <> '$nom_user' AND auteur ='$nom_user' ";

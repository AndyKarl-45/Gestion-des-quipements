                                    ...
                                    switch ($err){
                                        case 'passeword_retype';
                                            ...
                                            <div class="alert alert-danger">
                                                <strong>Erreur : </strong> Veillez resaisir vos mots de passe en faisant attention à la confirmation du nouveau mot de passe
                                            </div>
                                            <?php
                                            break;
                                        case 'samepassword_entered';
                                            ?>
                                            <div class="alert alert-danger">
                                                <strong>Erreur : </strong> Vaillez saisir un mot de passe différent de l'ancien
                                            </div>
                                            <?php
                                            break;
                                    ...
                                    <form action="profile.php" method="post" id="signupForm1" class="form-horizontal">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label" for="Old">Ancien mot de passe</label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label" for="Password"> Nouveau mot de passe</label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label" for="Confirm">Confirmation nouveau mot de passe</label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-9 col-sm-offset-4">
                                                    <button type="submit" name="save_password" class="btn btn-primary">Mettre à jour </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>

                                             ...
                                             while($row = $q->fetch())
                                                {
                                                            ...
                                                            $mention = $row['mention'];
                                                                       ...
                                                                       echo '
                                                                       <input type="hidden" name="id_etat[]" value="'.$id_aca.'">
                                             ...
                                             while($row = $q->fetch())
                                                {
                                                            ...
                                                            $id_prof= $row['id_etat_professionnel'];
                                                            ...
                                                            $date_depart = $row['date_depart'];
                                                                       ...
                                                                       echo '<tr>
                                                                       <input type="hidden" name="id_etat[]" value="'.$id_prof.'">
                                                                       <input type="hidden" name="statut" value="1">
                                                ...
                                                $iResult = $db->query('SELECT * FROM categorie_salariale');
                                                    ...
                                                    ?>
                                                        ...
                                                        <span class="help-block small-font" >GARANT</span>
                                                                ...
                                                                <?php  $sql = "SELECT DISTINCT * from garant_externe where id_garant_ex = '$garant'";

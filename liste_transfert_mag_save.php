                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <ul class="nav nav-pills"   style="float: right;">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="nouveau_transfert_mag_save.php">
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                     ...
                                                     // else
                                                         $query = "SELECT * from demande_equipement where (emetteur='E' and receveur='C') or (emetteur='E' and receveur='O') or (emetteur='E' and receveur='M')  order by date_debut , date_valide, id_ask_eq desc ";
...
<td align="center"><a href="details_demande_eq.php?id=<?php echo $id_ask_eq; ?>" style="color: black"> <?php if($receveur=='E'){ echo "Mag d'ennregistrement"; } elseif($receveur=='O') { echo "Mag congo"; }else{ echo "Mag maintenance";}?>  </a></td>
                ...
                <?php 
                            if($etat!=1){
                                ...
                                echo' <a class="btn btn-primary" href="modifier_transfert_mag_save.php?id='.$id_ask_eq.'"><i class="fa fa-pencil-alt"></i></a>||<a class="btn btn-primary" href="valider_transfert_mag.php?idi='.$id_ask_eq.'&ids='.$receveur.'&ide='.$emetteur.'"><i class="fa fa-check"></i></a>';

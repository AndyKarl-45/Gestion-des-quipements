    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des demandes d'équipements en envoie </h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <b>L'ensemble des demandes d'équipements en envoie.</b>
                                <b>
                                    <?php if ($lvl != 4){ ?>
                                        <!-- Nav pills -->
                                            ...
                                            <div class="table-responsive">
                                                <form method="post" action="" >
                                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        if($lvl == 3)
                                                            $query = "SELECT * from demande_materiel WHERE id_salles = $id_salle_user and etat=0 and etat_t=1 and id_salles!=0  order by id_ask_eq desc";
                                                        else
                                                            $query = "SELECT * from demande_materiel where etat=0 and etat_t=1 and id_salles!=0  order by id_ask_eq desc";
